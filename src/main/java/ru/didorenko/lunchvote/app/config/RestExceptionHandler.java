package ru.didorenko.lunchvote.app.config;
...
import ru.didorenko.lunchvote.common.error.AppException;
import ru.didorenko.lunchvote.common.error.ErrorType;
...
public class RestExceptionHandler {
    ...
    static final Map<Class<? extends Throwable>, ErrorType> HTTP_STATUS_MAP = new LinkedHashMap<>() {
        {
// more specific first
            put(NoResourceFoundException.class, ErrorType.NOT_FOUND);
            put(AuthenticationException.class, ErrorType.UNAUTHORIZED);
            put(FileNotFoundException.class, ErrorType.NOT_FOUND);
            ...
            put(ServletRequestBindingException.class, ErrorType.BAD_REQUEST);
    ...
    ProblemDetail bindException(BindException ex, HttpServletRequest request) {
        ...
        return createProblemDetail(ex, path, ErrorType.BAD_REQUEST, "BindException", Map.of("invalid_params", invalidParams));
    }
    ...
    ProblemDetail processException(@NonNull Throwable ex, HttpServletRequest request, Map<String, Object> additionalParams) {
        ...
        if (optType.isPresent()) {
            ...
            return createProblemDetail(ex, path, ErrorType.APP_ERROR, "Exception " + root.getClass().getSimpleName(), additionalParams);
        }
    }
